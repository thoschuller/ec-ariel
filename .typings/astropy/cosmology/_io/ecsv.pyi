...
def read_ecsv(filename: PathLike | ReadableFileLike[Table], index: int | str | None = None, *, move_to_meta: bool = False, cosmology: str | type[_CosmoT] | None = None, rename: Mapping[str, str] | None = None, **kwargs: Any) -> _CosmoT:
    ...
    **kwargs
    ...
    .. testcleanup::
        ...
        >>> temp_dir.cleanup()
    '''
def write_ecsv(cosmology: Cosmology, file: PathLike | WriteableFileLike[_TableT], *, overwrite: bool = False, cls: type[_TableT] = ..., cosmology_in_meta: bool = True, rename: Mapping[str, str] | None = None, **kwargs: Any) -> None:
    ...
    **kwargs
    ...
    .. testcleanup::
        ...
        >>> temp_dir.cleanup()
    '''
def ecsv_identify(origin: object, filepath: str | None, *args: object, **kwargs: object) -> bool:
