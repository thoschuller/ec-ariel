...
def dimensionless_redshift() -> Equivalency:
    ...
    """
def redshift_distance(cosmology: Cosmology | str | None = None, kind: Literal['comoving', 'lookback', 'luminosity'] = 'comoving', **atzkw: Any) -> Equivalency:
    ...
    **atzkw
    ...
    '''
def redshift_hubble(cosmology: Cosmology | str | None = None, **atzkw: Any) -> Equivalency:
    ...
    **atzkw
    ...
    """
def redshift_temperature(cosmology: Cosmology | str | None = None, **atzkw: Any) -> Equivalency:
    ...
    **atzkw
    ...
    <Quantity 3000.225 K>
    """
def with_redshift(cosmology: Cosmology | str | None = None, *, distance: Literal['comoving', 'lookback', 'luminosity'] = 'comoving', hubble: bool = True, Tcmb: bool = True, atzkw: Mapping[str, Any] | None = None) -> Equivalency:
