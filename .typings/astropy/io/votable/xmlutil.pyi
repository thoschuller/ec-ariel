...
def check_id(ID, name: str = 'ID', config: Incomplete | None = None, pos: Incomplete | None = None):
    """
    ...
    *name* is the name of the attribute being checked (used only for
    error messages).
    """
def fix_id(ID, config: Incomplete | None = None, pos: Incomplete | None = None):
    """
    ...
    """
def check_token(token, attr_name, config: Incomplete | None = None, pos: Incomplete | None = None):
    """
    Raises a `ValueError` if *token* is not a valid XML token.

    As defined by XML Schema Part 2.
    """
def check_mime_content_type(content_type, config: Incomplete | None = None, pos: Incomplete | None = None):
    """
    ...
    *content_type* is not a valid MIME content type.
    ...
    """
def check_anyuri(uri, config: Incomplete | None = None, pos: Incomplete | None = None):
    """
    Raises a `~astropy.io.votable.exceptions.VOTableSpecError` if
    *uri* is not a valid URI.
    ...
    """
def validate_schema(filename, version: str = '1.1'):
    '''
