...
def first_true_index(iterable, pred: Incomplete | None = None, default: Incomplete | None = None):
    """find the first index position for the which the callable pred returns True."""
def first_false_index(iterable, pred: Incomplete | None = None, default: Incomplete | None = None):
...
def sortmore(*args, **kw):
    ...
    Capture sorting indices::
        ...
        Out[2]: (['a', 'a', 'C', 'c', 'e', 'h', 'r', 'r', 'S', 't'],
                 [2, 4, 0, 5, 7, 1, 3, 8, 9, 6])
    """
def groupmore(func: Incomplete | None = None, *its):
