...
class Conf(_config.ConfigNamespace):
    ...
    """
    dataurl: Incomplete
    dataurl_mirror: Incomplete
    default_http_user_agent: Incomplete
    remote_timeout: Incomplete
    allow_internet: Incomplete
    compute_hash_block_size: Incomplete
    download_block_size: Incomplete
    delete_temporary_downloads_at_exit: Incomplete
...
def get_readable_fileobj(name_or_obj, encoding: Incomplete | None = None, cache: bool = False, show_progress: bool = True, remote_timeout: Incomplete | None = None, sources: Incomplete | None = None, http_headers: Incomplete | None = None, *, use_fsspec: Incomplete | None = None, fsspec_kwargs: Incomplete | None = None, close_files: bool = True) -> Generator[Incomplete]:
...
def get_file_contents(*args, **kwargs):
    ...
    """
def get_pkg_data_fileobj(data_name, package: Incomplete | None = None, encoding: Incomplete | None = None, cache: bool = True) -> Generator[Incomplete]:
    """
    ...
    """
def get_pkg_data_filename(data_name, package: Incomplete | None = None, show_progress: bool = True, remote_timeout: Incomplete | None = None):
    """
    Retrieves a data file from the standard locations for the package and
    ...
    """
def get_pkg_data_contents(data_name, package: Incomplete | None = None, encoding: Incomplete | None = None, cache: bool = True):
    """
    ...
    get_pkg_data_filename : returns a local name for a file containing the data
    """
def get_pkg_data_filenames(datadir, package: Incomplete | None = None, pattern: str = '*') -> Generator[Incomplete]:
    """
    ...
    tests::
        ...
        ...
    """
def get_pkg_data_fileobjs(datadir, package: Incomplete | None = None, pattern: str = '*', encoding: Incomplete | None = None) -> Generator[Incomplete]:
    """
...
def compute_hash(localfn):
    ...
    hash : str
        ...
        ``localfn`` file.
    """
def get_pkg_data_path(*path, package: Incomplete | None = None):
    ...
    *path : str
    ...
    """
def get_free_space_in_dir(path, unit: bool = False):
    """
...
def download_file(remote_url, cache: bool = False, show_progress: bool = True, timeout: Incomplete | None = None, sources: Incomplete | None = None, pkgname: str = 'astropy', http_headers: Incomplete | None = None, ssl_context: Incomplete | None = None, allow_insecure: bool = False):
    ...
    '''
def is_url_in_cache(url_key, pkgname: str = 'astropy'):
    ...
    """
def cache_total_size(pkgname: str = 'astropy'):
    """Return the total size in bytes of all files in the cache."""
def download_files_in_parallel(urls, cache: str = 'update', show_progress: bool = True, timeout: Incomplete | None = None, sources: Incomplete | None = None, multiprocessing_start_method: Incomplete | None = None, pkgname: str = 'astropy'):
    ...
    the cache.
    '''
def clear_download_cache(hashorurl: Incomplete | None = None, pkgname: str = 'astropy') -> None:
...
class CacheDamaged(ValueError):
    ...
    """
    bad_urls: Incomplete
    bad_files: Incomplete
    def __init__(self, *args, bad_urls: Incomplete | None = None, bad_files: Incomplete | None = None, **kwargs) -> None: ...

def check_download_cache(pkgname: str = 'astropy') -> None:
    ...
    OSError, RuntimeError
        ...
        misconfiguration.
    """
def import_file_to_cache(url_key, filename, remove_original: bool = False, pkgname: str = 'astropy', *, replace: bool = True):
    ...
    """
def get_cached_urls(pkgname: str = 'astropy'):
    """
    ...
    cache_contents : obtain a dictionary listing everything in the cache
    """
def cache_contents(pkgname: str = 'astropy'):
    ...
    """
def export_download_cache(filename_or_obj, urls: Incomplete | None = None, overwrite: bool = False, pkgname: str = 'astropy') -> None:
    ...
    """
def import_download_cache(filename_or_obj, urls: Incomplete | None = None, update_cache: bool = False, pkgname: str = 'astropy') -> None:
