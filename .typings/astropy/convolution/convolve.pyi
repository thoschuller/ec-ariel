from ._convolve import _convolveNd_c as _convolveNd_c
from .core import Kernel as Kernel, Kernel1D as Kernel1D, Kernel2D as Kernel2D, MAX_NORMALIZATION as MAX_NORMALIZATION
from .utils import KernelSizeError as KernelSizeError, has_even_axis as has_even_axis
from _typeshed import Incomplete
from astropy.modeling.convolution import Convolution as Convolution
from astropy.modeling.core import CompoundModel as CompoundModel, SPECIAL_OPERATORS as SPECIAL_OPERATORS
from astropy.nddata import support_nddata as support_nddata
from astropy.utils.compat.optional_deps import HAS_SCIPY as HAS_SCIPY
from astropy.utils.console import human_file_size as human_file_size
from astropy.utils.exceptions import AstropyUserWarning as AstropyUserWarning

_good_sizes: Incomplete
_good_range: Incomplete
__doctest_requires__: Incomplete
BOUNDARY_OPTIONS: Incomplete
...
def _next_fast_lengths(shape):
    ...
    """
def _copy_input_if_needed(input, dtype=..., order: str = 'C', nan_treatment: Incomplete | None = None, mask: Incomplete | None = None, fill_value: Incomplete | None = None): ...
def convolve(array, kernel, boundary: str = 'fill', fill_value: float = 0.0, nan_treatment: str = 'interpolate', normalize_kernel: bool = True, mask: Incomplete | None = None, preserve_nan: bool = False, normalization_zero_tol: float = 1e-08):
    '''
    ...
    '''
def convolve_fft(array, kernel, boundary: str = 'fill', fill_value: float = 0.0, nan_treatment: str = 'interpolate', normalize_kernel: bool = True, normalization_zero_tol: float = 1e-08, preserve_nan: bool = False, mask: Incomplete | None = None, crop: bool = True, return_fft: bool = False, fft_pad: Incomplete | None = None, psf_pad: Incomplete | None = None, min_wt: float = 0.0, allow_huge: bool = False, fftn=..., ifftn=..., complex_dtype=..., dealias: bool = False):
    '''
...
def interpolate_replace_nans(array, kernel, convolve=..., **kwargs):
    ...
    """
def convolve_models(model, kernel, mode: str = 'convolve_fft', **kwargs):
    """
    ...
    **kwargs : dict
    ...
    default : `~astropy.modeling.core.CompoundModel`
        Convolved model
    """
def convolve_models_fft(model, kernel, bounding_box, resolution, cache: bool = True, **kwargs):
    """
    Convolve two models using `~astropy.convolution.convolve_fft`.
