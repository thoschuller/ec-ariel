...
class Gaussian2DKernel(Kernel2D):
    ...
    _model: Incomplete
    _default_size: Incomplete
    def __init__(self, x_stddev, y_stddev: Incomplete | None = None, theta: float = 0.0, **kwargs) -> None: ...
...
class Trapezoid1DKernel(Kernel1D):
    ...
    _model: Incomplete
    _default_size: Incomplete
    def __init__(self, width, slope: float = 1.0, **kwargs) -> None: ...
...
class TrapezoidDisk2DKernel(Kernel2D):
    ...
    _model: Incomplete
    _default_size: Incomplete
    def __init__(self, radius, slope: float = 1.0, **kwargs) -> None: ...
