...
class SAMPClient:
    ...
    _addr: Incomplete
    _port: Incomplete
    _xmlrpcAddr: Incomplete
    _callable: Incomplete
    client: Incomplete
    _public_id: Incomplete
    _private_key: Incomplete
    _hub_id: Incomplete
    _notification_bindings: Incomplete
    _call_bindings: Incomplete
    _response_bindings: Incomplete
    _host_name: str
    hub: Incomplete
    _thread: Incomplete
    def __init__(self, hub, name: Incomplete | None = None, description: Incomplete | None = None, metadata: Incomplete | None = None, addr: Incomplete | None = None, port: int = 0, callable: bool = True) -> None: ...
    def start(self) -> None:
        """
    ...
    def _ping(self, private_key, sender_id, msg_id, msg_mtype, msg_params, message) -> None: ...
    def _client_env_get(self, private_key, sender_id, msg_id, msg_mtype, msg_params, message) -> None: ...
    ...
    def unregister(self) -> None:
        ...
        """
    def _set_xmlrpc_callback(self) -> None: ...
    def _declare_subscriptions(self, subscriptions: Incomplete | None = None) -> None: ...
    def declare_metadata(self, metadata: Incomplete | None = None) -> None:
        """
