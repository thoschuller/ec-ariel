...
def day_frac(val1, val2, factor: Incomplete | None = None, divisor: Incomplete | None = None):
    ...
    """
def quantity_day_frac(val1, val2: Incomplete | None = None):
...
_enough_decimal_places: int

def longdouble_to_twoval(val1, val2: Incomplete | None = None): ...
def decimal_to_twoval1(val1, val2: Incomplete | None = None): ...
def bytes_to_twoval1(val1, val2: Incomplete | None = None): ...
...
decimal_to_twoval: Incomplete
bytes_to_twoval: Incomplete
twoval_to_decimal: Incomplete
twoval_to_string: Incomplete
twoval_to_bytes: Incomplete
