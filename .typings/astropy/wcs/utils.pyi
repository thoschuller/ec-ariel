...
def wcs_to_celestial_frame(wcs):
    ...
    """
def celestial_frame_to_wcs(frame, projection: str = 'TAN'):
    """
...
def proj_plane_pixel_area(wcs):
    ...
    '''
def is_proj_plane_distorted(wcs, maxerr: float = 1e-05):
    '''
...
def non_celestial_pixel_scales(inwcs):
    ...
    """
def skycoord_to_pixel(coords, wcs, origin: int = 0, mode: str = 'all'):
    """
    ...
    """
def pixel_to_skycoord(xp, yp, wcs, origin: int = 0, mode: str = 'all', cls: Incomplete | None = None):
    """
...
def pixel_to_pixel(wcs_in, wcs_out, *inputs):
    ...
    *inputs :
    ...
    """
def local_partial_pixel_derivatives(wcs, *pixel, normalize_by_world: bool = False):
    """
    ...
    *pixel : float
    ...
    """
def fit_wcs_from_points(xy, world_coords, proj_point: str = 'center', projection: str = 'TAN', sip_degree: Incomplete | None = None):
    """
