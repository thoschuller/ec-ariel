...
class Ticks(Line2D):
    ...
    * `xtick.color`
    ...
    """
    _frame: Incomplete
    _display_minor_ticks: bool
    def __init__(self, frame: Incomplete | None = None, ticksize: Incomplete | None = None, **kwargs) -> None: ...
    def display_minor_ticks(self, display_minor_ticks) -> None: ...
    def get_display_minor_ticks(self): ...
    _tick_out: Incomplete
    ...
    angle: Incomplete
    disp: Incomplete
    minor_world: Incomplete
    minor_pixel: Incomplete
    minor_angle: Incomplete
    minor_disp: Incomplete
    def clear(self) -> None: ...
    ...
    ticks_locs: Incomplete
    def draw(self, renderer) -> None:
        """
        Draw the ticks.
        """
    def _draw_ticks(self, renderer, pixel_array, angle_array, offset) -> None:
        """
