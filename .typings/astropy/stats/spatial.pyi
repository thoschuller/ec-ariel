...
class RipleysKEstimator:
    ...
    """
    def __init__(self, area: float, x_max: float | None = None, y_max: float | None = None, x_min: float | None = None, y_min: float | None = None) -> None: ...
    @property
    def area(self) -> float: ...
    _area: Incomplete
    @area.setter
    ...
    def __call__(self, data: NDArray[float], radii: NDArray[float], mode: _ModeOps = 'none') -> NDArray[float]: ...
    ...
    def poisson(self, radii: NDArray[float]) -> NDArray[float]:
        ...
        """
    def Lfunction(self, data: NDArray[float], radii: NDArray[float], mode: _ModeOps = 'none') -> NDArray[float]:
        """
        Evaluates the L function at ``radii``. For parameter description
        see ``evaluate`` method.
        """
    def Hfunction(self, data: NDArray[float], radii: NDArray[float], mode: _ModeOps = 'none') -> NDArray[float]:
        """
        Evaluates the H function at ``radii``. For parameter description
        see ``evaluate`` method.
        """
    def evaluate(self, data: NDArray[float], radii: NDArray[float], mode: _ModeOps = 'none') -> NDArray[float]:
        """
