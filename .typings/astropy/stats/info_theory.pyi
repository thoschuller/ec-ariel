...
def bayesian_info_criterion(log_likelihood: float, n_params: int, n_samples: int) -> float:
...
def bayesian_info_criterion_lsq(ssr: float, n_params: int, n_samples: int) -> float:
    ...
    '''
def akaike_info_criterion(log_likelihood: float, n_params: int, n_samples: int) -> float:
    '''
