...
def calculate_bin_edges(a: ArrayLike, bins: int | list[int | float] | Literal['blocks', 'knuth', 'scott', 'freedman'] | None = 10, range: tuple[int | float, int | float] | None = None, weights: ArrayLike | None = None) -> NDArray[float]:
    """
    ...
    bins : ndarray
        Histogram bin edges
    """
def histogram(a: ArrayLike, bins: int | list[int | float] | Literal['blocks', 'knuth', 'scott', 'freedman'] | None = 10, range: tuple[int | float, int | float] | None = None, weights: ArrayLike | None = None, **kwargs) -> tuple[NDArray, NDArray]:
    ...
    **kwargs : dict, optional
    ...
    numpy.histogram
    """
def scott_bin_width(data: ArrayLike, return_bins: bool | None = False) -> float | tuple[float, NDArray]:
    ...
    histogram
    '''
def freedman_bin_width(data: ArrayLike, return_bins: bool | None = False) -> float | tuple[float, NDArray]:
    ...
    histogram
    '''
def knuth_bin_width(data: ArrayLike, return_bins: bool | None = False, quiet: bool | None = True) -> float | tuple[float, NDArray]:
