...
def aggregate_downsample(time_series, *, time_bin_size: Incomplete | None = None, time_bin_start: Incomplete | None = None, time_bin_end: Incomplete | None = None, n_bins: Incomplete | None = None, aggregate_func: Incomplete | None = None):
    """
