...
class TimeSeries(BaseTimeSeries):
    ...
    **kwargs : dict, optional
    ...
    def __init__(self, data: Incomplete | None = None, *, time: Incomplete | None = None, time_start: Incomplete | None = None, time_delta: Incomplete | None = None, n_samples: Incomplete | None = None, **kwargs) -> None: ...
    @property
    def time(self):
        """
        The time values.
        """
    def fold(self, period: Incomplete | None = None, epoch_time: Incomplete | None = None, epoch_phase: int = 0, wrap_phase: Incomplete | None = None, normalize_phase: bool = False):
        """
    ...
    def add_columns(self, *args, **kwargs):
        ...
        """
    @classmethod
    def from_pandas(self, df, time_scale: str = 'utc'):
        """
    ...
    def to_pandas(self):
        ...
        """
    @classmethod
    def read(self, filename, time_column: Incomplete | None = None, time_format: Incomplete | None = None, time_scale: Incomplete | None = None, format: Incomplete | None = None, *args, **kwargs):
        """
