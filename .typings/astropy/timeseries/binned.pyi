...
class BinnedTimeSeries(BaseTimeSeries):
    ...
    **kwargs : dict, optional
    ...
    def __init__(self, data: Incomplete | None = None, *, time_bin_start: Incomplete | None = None, time_bin_end: Incomplete | None = None, time_bin_size: Incomplete | None = None, n_bins: Incomplete | None = None, **kwargs) -> None: ...
    @property
    ...
    @classmethod
    def read(self, filename, time_bin_start_column: Incomplete | None = None, time_bin_end_column: Incomplete | None = None, time_bin_size_column: Incomplete | None = None, time_bin_size_unit: Incomplete | None = None, time_format: Incomplete | None = None, time_scale: Incomplete | None = None, format: Incomplete | None = None, *args, **kwargs):
        """
