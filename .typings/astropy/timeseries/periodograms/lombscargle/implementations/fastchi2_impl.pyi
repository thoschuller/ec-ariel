from .utils import trig_sum as trig_sum
from _typeshed import Incomplete

def lombscargle_fastchi2(t, y, dy, f0, df, Nf, normalization: str = 'standard', fit_mean: bool = True, center_data: bool = True, nterms: int = 1, use_fft: bool = True, trig_sum_kwds: Incomplete | None = None):
