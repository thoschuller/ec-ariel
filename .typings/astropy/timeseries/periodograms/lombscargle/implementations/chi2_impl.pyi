from .mle import design_matrix as design_matrix

def lombscargle_chi2(t, y, dy, frequency, normalization: str = 'standard', fit_mean: bool = True, center_data: bool = True, nterms: int = 1):
