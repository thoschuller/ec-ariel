...
def pdf_single(z, N, normalization, dH: int = 1, dK: int = 3):
    ...
    """
def fap_single(z, N, normalization, dH: int = 1, dK: int = 3):
    ...
    .. [1] Baluev, R.V. MNRAS 385, 1279 (2008)
    """
def inv_fap_single(fap, N, normalization, dH: int = 1, dK: int = 3):
    ...
    .. [1] Baluev, R.V. MNRAS 385, 1279 (2008)
    """
def cdf_single(z, N, normalization, dH: int = 1, dK: int = 3):
    ...
    .. [1] Baluev, R.V. MNRAS 385, 1279 (2008)
    """
def tau_davies(Z, fmax, t, y, dy, normalization: str = 'standard', dH: int = 1, dK: int = 3):
    """tau factor for estimating Davies bound (Baluev 2008, Table 1)."""
def fap_naive(Z, fmax, t, y, dy, normalization: str = 'standard'):
    """False Alarm Probability based on estimated number of indep frequencies."""
def inv_fap_naive(fap, fmax, t, y, dy, normalization: str = 'standard'):
    """Inverse FAP based on estimated number of indep frequencies."""
def fap_davies(Z, fmax, t, y, dy, normalization: str = 'standard'):
    """Davies upper-bound to the false alarm probability.

    (Eqn 5 of Baluev 2008)
    """
def inv_fap_davies(p, fmax, t, y, dy, normalization: str = 'standard'):
    """Inverse of the davies upper-bound."""
def fap_baluev(Z, fmax, t, y, dy, normalization: str = 'standard'):
    """Alias-free approximation to false alarm probability.

    (Eqn 6 of Baluev 2008)
    """
def inv_fap_baluev(p, fmax, t, y, dy, normalization: str = 'standard'):
    """Inverse of the Baluev alias-free approximation."""
def _bootstrap_max(t, y, dy, fmax, normalization, random_seed, n_bootstrap: int = 1000):
    """Generate a sequence of bootstrap estimates of the max."""
def fap_bootstrap(Z, fmax, t, y, dy, normalization: str = 'standard', n_bootstraps: int = 1000, random_seed: Incomplete | None = None):
    """Bootstrap estimate of the false alarm probability."""
def inv_fap_bootstrap(fap, fmax, t, y, dy, normalization: str = 'standard', n_bootstraps: int = 1000, random_seed: Incomplete | None = None):
    """Bootstrap estimate of the inverse false alarm probability."""

METHODS: Incomplete

def false_alarm_probability(Z, fmax, t, y, dy, normalization: str = 'standard', method: str = 'baluev', method_kwds: Incomplete | None = None):
...
INV_METHODS: Incomplete

def false_alarm_level(p, fmax, t, y, dy, normalization, method: str = 'baluev', method_kwds: Incomplete | None = None):
