from . import _statistics as _statistics
from .implementations import available_methods as available_methods, lombscargle as lombscargle
from .implementations.mle import design_matrix as design_matrix, periodic_fit as periodic_fit
from _typeshed import Incomplete
from astropy import units as units
from astropy.time import Time as Time, TimeDelta as TimeDelta
from astropy.timeseries.periodograms.base import BasePeriodogram as BasePeriodogram
...
class LombScargle(BasePeriodogram):
    ...
    def __init__(self, t, y, dy: Incomplete | None = None, fit_mean: bool = True, center_data: bool = True, nterms: int = 1, normalization: str = 'standard') -> None: ...
    ...
    def autofrequency(self, samples_per_peak: int = 5, nyquist_factor: int = 5, minimum_frequency: Incomplete | None = None, maximum_frequency: Incomplete | None = None, return_freq_limits: bool = False):
        ...
        '''
    def autopower(self, method: str = 'auto', method_kwds: Incomplete | None = None, normalization: Incomplete | None = None, samples_per_peak: int = 5, nyquist_factor: int = 5, minimum_frequency: Incomplete | None = None, maximum_frequency: Incomplete | None = None):
        ...
        """
    def power(self, frequency, normalization: Incomplete | None = None, method: str = 'auto', assume_regular_frequency: bool = False, method_kwds: Incomplete | None = None):
    ...
    def model_parameters(self, frequency, units: bool = True):
        ...
        offset
        """
    def design_matrix(self, frequency, t: Incomplete | None = None):
        ...
        offset
        """
    def distribution(self, power, cumulative: bool = False):
        ...
        dist : np.ndarray
            ...
            the provided powers.
        """
    def false_alarm_probability(self, power, method: str = 'baluev', samples_per_peak: int = 5, nyquist_factor: int = 5, minimum_frequency: Incomplete | None = None, maximum_frequency: Incomplete | None = None, method_kwds: Incomplete | None = None):
        ...
        '''
    def false_alarm_level(self, false_alarm_probability, method: str = 'baluev', samples_per_peak: int = 5, nyquist_factor: int = 5, minimum_frequency: Incomplete | None = None, maximum_frequency: Incomplete | None = None, method_kwds: Incomplete | None = None):
