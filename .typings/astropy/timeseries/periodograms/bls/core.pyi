...
class BoxLeastSquares(BasePeriodogram):
    ...
    t: Incomplete
    _tstart: Incomplete
    def __init__(self, t, y, dy: Incomplete | None = None) -> None: ...
    def autoperiod(self, duration, minimum_period: Incomplete | None = None, maximum_period: Incomplete | None = None, minimum_n_transit: int = 3, frequency_factor: float = 1.0):
        ...
        """
    def autopower(self, duration, objective: Incomplete | None = None, method: Incomplete | None = None, oversample: int = 10, minimum_n_transit: int = 3, minimum_period: Incomplete | None = None, maximum_period: Incomplete | None = None, frequency_factor: float = 1.0):
        ...
        """
    def power(self, period, duration, objective: Incomplete | None = None, method: Incomplete | None = None, oversample: int = 10):
