...
def overlap_slices(large_array_shape, small_array_shape, position, mode: str = 'partial'):
    """
    ...
    """
def extract_array(array_large, shape, position, mode: str = 'partial', fill_value=..., return_position: bool = False):
    """
...
class Cutout2D:
    ...
    """
    data: Incomplete
    input_position_cutout: Incomplete
    slices_original: Incomplete
    slices_cutout: Incomplete
    shape: Incomplete
    input_position_original: Incomplete
    shape_input: Incomplete
    _origin_original_true: Incomplete
    wcs: Incomplete
    def __init__(self, data, position, size, wcs: Incomplete | None = None, mode: str = 'trim', fill_value=..., copy: bool = False) -> None: ...
    ...
    def to_cutout_position(self, original_position):
        ...
        """
    def plot_on_original(self, ax: Incomplete | None = None, fill: bool = False, **kwargs):
        """
