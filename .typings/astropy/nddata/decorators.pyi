...
def support_nddata(_func: Incomplete | None = None, accepts=..., repack: bool = False, returns: Incomplete | None = None, keeps: Incomplete | None = None, **attribute_argument_mapping):
