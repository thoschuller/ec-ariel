...
class Angle(SpecificTypeQuantity):
    ...
    def __new__(cls, angle, unit: Incomplete | None = None, dtype=..., copy: bool = True, **kwargs): ...
    @staticmethod
    ...
    def signed_dms(self):
        ...
        """
    def to_string(self, unit: Incomplete | None = None, decimal: bool = False, sep: str = 'fromunit', precision: int | None = None, alwayssign: bool = False, pad: bool = False, fields: int = 3, format: str | None = None) -> str:
    ...
    def wrap_at(self, wrap_angle, inplace: bool = False):
        ...
        """
    def is_within_bounds(self, lower: Incomplete | None = None, upper: Incomplete | None = None):
        """
        ...
        """
    def _str_helper(self, format: Incomplete | None = None): ...
...
class Latitude(Angle):
    ...
    """
    def __new__(cls, angle, unit: Incomplete | None = None, **kwargs): ...
    def _validate_angles(self, angles: Incomplete | None = None) -> None:
...
class Longitude(Angle):
    ...
    """
    _wrap_angle: Incomplete
    _default_wrap_angle: Incomplete
    info: Incomplete
    def __new__(cls, angle, unit: Incomplete | None = None, wrap_angle: Incomplete | None = None, **kwargs): ...
    def __setitem__(self, item, value) -> None: ...
    @property
    def wrap_angle(self): ...
    @wrap_angle.setter
