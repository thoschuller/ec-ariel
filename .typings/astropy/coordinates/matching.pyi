...
def match_coordinates_3d(matchcoord, catalogcoord, nthneighbor: int = 1, storekdtree: str = 'kdtree_3d'):
    """
    ...
    or it will fail.
    """
def match_coordinates_sky(matchcoord, catalogcoord, nthneighbor: int = 1, storekdtree: str = 'kdtree_sky'):
    """
    ...
    or it will fail.
    """
def search_around_3d(coords1, coords2, distlimit, storekdtree: str = 'kdtree_3d'):
    """
    ...
    release.
    """
def search_around_sky(coords1, coords2, seplimit, storekdtree: str = 'kdtree_sky'):
    """
