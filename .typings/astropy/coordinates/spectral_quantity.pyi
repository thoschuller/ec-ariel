...
class SpectralQuantity(SpecificTypeQuantity):
    ...
    def __new__(cls, value, unit: Incomplete | None = None, doppler_rest: Incomplete | None = None, doppler_convention: Incomplete | None = None, **kwargs): ...
    _doppler_rest: Incomplete
    _doppler_convention: Incomplete
    ...
    def doppler_convention(self, value) -> None:
        ...
        """
    def to(self, unit, equivalencies=[], doppler_rest: Incomplete | None = None, doppler_convention: Incomplete | None = None):
        """
        ...
        """
    def to_value(self, unit: Incomplete | None = None, *args, **kwargs): ...
