...
class Distance(u.SpecificTypeQuantity):
    ...
    * Parallax
    ...
    def __new__(cls, value: Incomplete | None = None, unit: Incomplete | None = None, z: Incomplete | None = None, cosmology: Incomplete | None = None, distmod: Incomplete | None = None, parallax: Incomplete | None = None, dtype=..., copy: bool = True, order: Incomplete | None = None, subok: bool = False, ndmin: int = 0, allow_negative: bool = False): ...
    @property
    def z(self):
        """Short for ``self.compute_z()``."""
    def compute_z(self, cosmology: Incomplete | None = None, **atzkw):
        """
