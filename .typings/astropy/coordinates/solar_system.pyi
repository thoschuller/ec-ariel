...
__all__ = ['get_body', 'get_body_barycentric', 'get_body_barycentric_posvel', 'solar_system_ephemeris']
...
def get_body_barycentric_posvel(body, time, ephemeris: Incomplete | None = None):
    ...
    {_EPHEMERIS_NOTE}
    """
def get_body_barycentric(body, time, ephemeris: Incomplete | None = None):
    ...
    {_EPHEMERIS_NOTE}
    """
def get_body(body, time, location: Incomplete | None = None, ephemeris: Incomplete | None = None):
    """
