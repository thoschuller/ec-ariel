...
class MuJoCoBindingsTest(parameterized.TestCase):
    ...
    def test_mjvisual_repr(self) -> None: ...
    ...
    def test_timer_installed_by_default(self) -> None: ...
    count: int
    ...
    def test_mjd_quat_integrate(self) -> None: ...
    ...
    def _assert_attributes_equal(self, actual_obj, expected_obj, attr_to_compare) -> None: ...
