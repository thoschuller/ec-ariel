...
class MuJoCoRolloutTest(parameterized.TestCase):
    ...
    def test_infer_nbatch_initial_state(self, model_name) -> None: ...
    def test_infer_nbatch_control(self, model_name) -> None: ...
    def test_infer_nbatch_warmstart(self, model_name) -> None: ...
    def test_infer_nbatch_state(self, model_name) -> None: ...
    def test_infer_nbatch_sensordata(self, model_name) -> None: ...
    ...
    def test_length_one_model_list(self) -> None: ...
