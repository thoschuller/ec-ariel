...
class _ExecOrderTracer:
    ...
    def _patched_call_module(self, call_module: Callable, exec_info: _ExecutionInfo, module: nn.Module, forward: Callable, args: tuple[Any, ...], kwargs: dict[str, Any]) -> Any:
        ...
        """
    def _patched_create_proxy(self, create_proxy: Callable, exec_info: _ExecutionInfo, fqn_to_param: dict[str, nn.Parameter], kind: str, target: torch.fx.node.Target, args: tuple[Any, ...], kwargs: dict[str, Any], name: str | None = None, type_expr: Any | None = None, proxy_factory_fn: Callable[[torch.fx.Node], torch.fx.Proxy] | None = None) -> torch.fx.Proxy:
        """
