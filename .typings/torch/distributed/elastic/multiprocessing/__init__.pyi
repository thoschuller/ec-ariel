from torch.distributed.elastic.multiprocessing.api import DefaultLogsSpecs as DefaultLogsSpecs, LogsDest as LogsDest, LogsSpecs as LogsSpecs, MultiprocessContext as MultiprocessContext, PContext as PContext, ProcessFailure as ProcessFailure, RunProcsResult as RunProcsResult, SignalException as SignalException, Std as Std, SubprocessContext as SubprocessContext, to_map as to_map
from typing import Callable

__all__ = ['start_processes', 'MultiprocessContext', 'PContext', 'ProcessFailure', 'RunProcsResult', 'SignalException', 'Std', 'LogsDest', 'LogsSpecs', 'DefaultLogsSpecs', 'SubprocessContext', 'to_map']

def start_processes(name: str, entrypoint: Callable | str, args: dict[int, tuple], envs: dict[int, dict[str, str]], logs_specs: LogsSpecs, log_line_prefixes: dict[int, str] | None = None, start_method: str = 'spawn') -> PContext:
    '''
