...
class AsyncStager(Protocol):
    ...
    '''
    _synchronize_after_execute: bool
    @property
...
class BlockingAsyncStager(AsyncStager):
    ...
    """
    _synchronize_after_execute: bool
    cache_staged_state_dict: Incomplete
    type_check: Incomplete
    state_dict_cache: STATE_DICT_TYPE | None
    def __init__(self, cache_staged_state_dict: bool = False, type_check: bool = False) -> None:
        """
