...
def allow_in_graph(fn):
    ...
    '''
def substitute_in_graph(original_fn: Callable[_P, _R], *, can_constant_fold_through: bool = False, skip_signature_check: bool = False) -> Callable[[Callable[_P, _R]], Callable[_P, _R]]:
    '''
...
def assume_constant_result(fn):
    ...
    """
def disable(fn=None, recursive: bool = True, *, reason=None):
    """
    ...
    """
def set_stance(stance: str = 'default', *, skip_guard_eval_unsafe: bool = False, force_backend=None):
    '''
...
def skip_guard_on_all_nn_modules_unsafe(guard_entries):
    ...
    >> )
    '''
def keep_tensor_guards_unsafe(guard_entries, keep_parameters: bool = False):
    '''
