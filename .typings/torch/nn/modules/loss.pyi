...
class NLLLoss(_WeightedLoss):
    ...
    __constants__: Incomplete
    ignore_index: int
    def __init__(self, weight: Tensor | None = None, size_average=None, ignore_index: int = -100, reduce=None, reduction: str = 'mean') -> None: ...
    def forward(self, input: Tensor, target: Tensor) -> Tensor: ...
...
class BCEWithLogitsLoss(_Loss):
    ...
    def __init__(self, weight: Tensor | None = None, size_average=None, reduce=None, reduction: str = 'mean', pos_weight: Tensor | None = None) -> None: ...
    def forward(self, input: Tensor, target: Tensor) -> Tensor: ...
...
class CrossEntropyLoss(_WeightedLoss):
    ...
    def __init__(self, weight: Tensor | None = None, size_average=None, ignore_index: int = -100, reduce=None, reduction: str = 'mean', label_smoothing: float = 0.0) -> None: ...
    def forward(self, input: Tensor, target: Tensor) -> Tensor: ...
...
class MultiMarginLoss(_WeightedLoss):
    ...
    margin: float
    p: int
    def __init__(self, p: int = 1, margin: float = 1.0, weight: Tensor | None = None, size_average=None, reduce=None, reduction: str = 'mean') -> None: ...
    def forward(self, input: Tensor, target: Tensor) -> Tensor: ...
...
class TripletMarginLoss(_Loss):
    ...
    eps: float
    swap: bool
    def __init__(self, margin: float = 1.0, p: float = 2.0, eps: float = 1e-06, swap: bool = False, size_average=None, reduce=None, reduction: str = 'mean') -> None: ...
