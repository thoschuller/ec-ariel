import os
import torch
from . import errors as errors, ops as ops, symbolic_caffe2 as symbolic_caffe2, symbolic_helper as symbolic_helper, symbolic_opset10 as symbolic_opset10, symbolic_opset11 as symbolic_opset11, symbolic_opset12 as symbolic_opset12, symbolic_opset13 as symbolic_opset13, symbolic_opset14 as symbolic_opset14, symbolic_opset15 as symbolic_opset15, symbolic_opset16 as symbolic_opset16, symbolic_opset17 as symbolic_opset17, symbolic_opset18 as symbolic_opset18, symbolic_opset19 as symbolic_opset19, symbolic_opset20 as symbolic_opset20, symbolic_opset7 as symbolic_opset7, symbolic_opset8 as symbolic_opset8, symbolic_opset9 as symbolic_opset9, utils as utils
from ._internal._exporter_legacy import enable_fake_mode as enable_fake_mode
from ._internal.exporter._onnx_program import ONNXProgram as ONNXProgram
from ._internal.onnxruntime import is_onnxrt_backend_supported as is_onnxrt_backend_supported
from ._type_utils import JitScalarType as JitScalarType
from .errors import OnnxExporterError as OnnxExporterError
from .utils import register_custom_op_symbolic as register_custom_op_symbolic, select_model_mode_for_export as select_model_mode_for_export, unregister_custom_op_symbolic as unregister_custom_op_symbolic
...
class ExportOptions:
    ...
    def __init__(self, *, dynamic_shapes: bool | None = None) -> None: ...

def dynamo_export(model: torch.nn.Module | Callable | torch.export.ExportedProgram, /, *model_args, export_options: ExportOptions | None = None, **model_kwargs) -> ONNXProgram:
