...
def biweight_location(data: ArrayLike, c: float = 6.0, M: float | ArrayLike | None = None, axis: int | tuple[int, ...] | None = None, *, ignore_nan: bool | None = False) -> float | NDArray[float]:
    """
    ...
    0.01535330525461019
    """
def biweight_scale(data: ArrayLike, c: float = 9.0, M: float | ArrayLike | None = None, axis: int | tuple[int, ...] | None = None, modify_sample_size: bool | None = False, *, ignore_nan: bool | None = False) -> float | NDArray[float]:
    """
    ...
    1.0239311812635818
    """
def biweight_midvariance(data: ArrayLike, c: float = 9.0, M: float | ArrayLike | None = None, axis: int | tuple[int, ...] | None = None, modify_sample_size: bool | None = False, *, ignore_nan: bool | None = False) -> float | NDArray[float]:
    """
    ...
    1.0484350639638342
    """
def biweight_midcovariance(data: ArrayLike, c: float = 9.0, M: float | ArrayLike | None = None, modify_sample_size: bool | None = False) -> NDArray[float]:
    """
    ...
    """
def biweight_midcorrelation(x: ArrayLike, y: ArrayLike, c: float = 9.0, M: float | ArrayLike | None = None, modify_sample_size: bool | None = False) -> float:
    """
