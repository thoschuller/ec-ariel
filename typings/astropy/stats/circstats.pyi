...
def circmean(data: NDArray | Quantity, axis: int | None = None, weights: NDArray | None = None) -> NDArray | Quantity:
    ...
    '''
def circvar(data: NDArray | Quantity, axis: int | None = None, weights: NDArray | None = None) -> NDArray | Quantity:
    ...
    implementation.
    '''
def circstd(data: NDArray | Quantity, axis: int | None = None, weights: NDArray | None = None, method: str | None = 'angular') -> NDArray | Quantity:
    ...
    '''
def circmoment(data: NDArray | Quantity, p: float = 1.0, centered: bool | None = False, axis: int | None = None, weights: NDArray | None = None) -> NDArray | Quantity:
    ...
    .. [2] C. Agostinelli, U. Lund. "Circular Statistics from \'Topics in
       ...
       <https://cran.r-project.org/web/packages/CircStats/CircStats.pdf>
    '''
def circcorrcoef(alpha: NDArray | Quantity, beta: NDArray | Quantity, axis: int | None = None, weights_alpha: NDArray | None = None, weights_beta: NDArray | None = None) -> NDArray | Quantity:
    ...
    .. [2] C. Agostinelli, U. Lund. "Circular Statistics from \'Topics in
       ...
       <https://cran.r-project.org/web/packages/CircStats/CircStats.pdf>
    '''
def rayleightest(data: NDArray | Quantity, axis: int | None = None, weights: NDArray | None = None) -> float | Quantity:
    ...
    '''
def vtest(data: NDArray | Quantity, mu: float | Quantity | None = 0.0, axis: int | None = None, weights: NDArray | None = None) -> float | Quantity:
    ...
    .. [3] M. Chirstman., C. Miller. "Testing a Sample of Directions for
       Uniformity." Lecture Notes, STA 6934/5805. University of Florida, 2007.
    '''
def vonmisesmle(data: NDArray | Quantity, axis: int | None = None, weights: NDArray | None = None) -> tuple[float | Quantity, float | Quantity]:
