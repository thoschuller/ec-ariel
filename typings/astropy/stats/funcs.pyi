...
gaussian_sigma_to_fwhm: Incomplete
gaussian_fwhm_to_sigma: Incomplete

def binom_conf_interval(k: int | NDArray, n: int | NDArray, confidence_level: float = 0.68269, interval: Literal['wilson', 'jeffreys', 'flat', 'wald'] = 'wilson') -> NDArray:
    ...
    **4. The Wald Interval.** This interval is given by
    ...
    '''
def binned_binom_proportion(x: ArrayLike, success: ArrayLike, bins: int | ArrayLike = 10, range: tuple[float, float] | None = None, confidence_level: float = 0.68269, interval: Literal['wilson', 'jeffreys', 'flat', 'wald'] = 'wilson') -> tuple[NDArray, NDArray, NDArray, NDArray]:
    ...
    '''
def poisson_conf_interval(n: int | NDArray, interval: Literal['root-n', 'root-n-0', 'pearson', 'sherpagehrels', 'frequentist-confidence', 'kraft-burrows-nousek'] = 'root-n', sigma: float = 1.0, background: float = 0.0, confidence_level: float | None = None) -> NDArray:
    ...
    **6. \'kraft-burrows-nousek\'** This is a Bayesian approach which allows
    ...
    '''
def median_absolute_deviation(data: ArrayLike, axis: int | tuple[int, ...] | None = None, func: Callable | None = None, ignore_nan: bool | None = False) -> float | NDArray:
    """
    ...
    mad_std
    """
def mad_std(data: ArrayLike, axis: int | tuple[int, ...] | None = None, func: Callable | None = None, ignore_nan: bool | None = False) -> float | NDArray:
    """
    ...
    """
def signal_to_noise_oir_ccd(t: float | NDArray, source_eps: float, sky_eps: float, dark_eps: float, rd: float, npix: float, gain: float = 1.0) -> float | NDArray:
    ...
    """
def bootstrap(data: NDArray, bootnum: int = 100, samples: int | None = None, bootfunc: Callable | None = None) -> NDArray:
...
def kuiper_false_positive_probability(D: float, N: float) -> float:
    ...
    '''
def kuiper(data: ArrayLike, cdf: Callable = ..., args: tuple | list | None = ()) -> tuple[float, float]:
...
def kuiper_two(data1: ArrayLike, data2: ArrayLike) -> tuple[float, float]:
    ...
    """
def fold_intervals(intervals: list[tuple[float, float, float]]) -> tuple[NDArray[float], NDArray[float]]:
