...
def lombscargle_fast(t, y, dy, f0, df, Nf, center_data: bool = True, fit_mean: bool = True, normalization: str = 'standard', use_fft: bool = True, trig_sum_kwds: Incomplete | None = None):
