...
def design_matrix(t, frequency, dy: Incomplete | None = None, bias: bool = True, nterms: int = 1):
    ...
    """
def periodic_fit(t, y, dy, frequency, t_fit, center_data: bool = True, fit_mean: bool = True, nterms: int = 1):
