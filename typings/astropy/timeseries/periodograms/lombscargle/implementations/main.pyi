...
def lombscargle(t, y, dy: Incomplete | None = None, frequency: Incomplete | None = None, method: str = 'auto', assume_regular_frequency: bool = False, normalization: str = 'standard', fit_mean: bool = True, center_data: bool = True, method_kwds: Incomplete | None = None, nterms: int = 1):
    """
