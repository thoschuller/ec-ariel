...
def compute_chi2_ref(y, dy: Incomplete | None = None, center_data: bool = True, fit_mean: bool = True):
    ...
    """
def convert_normalization(Z, N, from_normalization, to_normalization, chi2_ref: Incomplete | None = None):
