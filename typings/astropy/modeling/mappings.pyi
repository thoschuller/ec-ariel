...
class Mapping(FittableModel):
    ...
    outputs: Incomplete
    _mapping: Incomplete
    _input_units_strict: Incomplete
    _input_units_allow_dimensionless: Incomplete
    def __init__(self, mapping, n_inputs: Incomplete | None = None, name: Incomplete | None = None, meta: Incomplete | None = None) -> None: ...
    @property
    def n_inputs(self): ...
    @property
    def n_outputs(self): ...
...
class Identity(Mapping):
    ...
    """
    linear: bool
    def __init__(self, n_inputs, name: Incomplete | None = None, meta: Incomplete | None = None) -> None: ...
    def __repr__(self) -> str: ...
    @property
    def inverse(self):
        """
...
class UnitsMapping(Model):
    ...
    _input_units_allow_dimensionless: Incomplete
    def __init__(self, mapping, input_units_equivalencies: Incomplete | None = None, input_units_allow_dimensionless: bool = False, name: Incomplete | None = None, meta: Incomplete | None = None) -> None: ...
    _input_units: Incomplete
