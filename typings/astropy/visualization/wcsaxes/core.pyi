...
class WCSAxes(Axes):
    ...
    *args
    ...
    """
    _bboxes: Incomplete
    frame_class: Incomplete
    transData: Incomplete
    format_coord: Incomplete
    _display_coords_index: int
    patch: Incomplete
    _wcsaxesartist: Incomplete
    _drawn: bool
    def __init__(self, fig, *args, wcs: Incomplete | None = None, transform: Incomplete | None = None, coord_meta: Incomplete | None = None, transData: Incomplete | None = None, slices: Incomplete | None = None, frame_class: Incomplete | None = None, **kwargs) -> None:
        """ """
    def _display_world_coords(self, x, y): ...
    def _set_cursor_prefs(self, event, **kwargs) -> None: ...
    def _hide_parent_artists(self) -> None: ...
    ...
    wcs: Incomplete
    coords: Incomplete
    _transform_pixel2world: Incomplete
    _all_coords: Incomplete
    def reset_wcs(self, wcs: Incomplete | None = None, slices: Incomplete | None = None, transform: Incomplete | None = None, coord_meta: Incomplete | None = None) -> None:
        """
        Reset the current Axes, to use a new WCS object.
        """
    def _update_tick_and_label_positions(self, keep_coord_range: bool = False) -> None:
        """
    ...
    def draw(self, renderer) -> None:
        """Draw the axes."""
    def set_xlabel(self, xlabel: Incomplete | None = None, labelpad: int = 1, loc: Incomplete | None = None, **kwargs) -> None:
        """Set x-label."""
    def set_ylabel(self, ylabel: Incomplete | None = None, labelpad: int = 1, loc: Incomplete | None = None, **kwargs):
        """Set y-label."""
    def get_xlabel(self): ...
    def get_ylabel(self): ...
    overlay_coords: Incomplete
    def get_coords_overlay(self, frame, coord_meta: Incomplete | None = None):
    ...
    def grid(self, b: Incomplete | None = None, axis: str = 'both', *, which: str = 'major', **kwargs) -> None:
        """
...
class WCSAxesSubplot(Incomplete):
    """
