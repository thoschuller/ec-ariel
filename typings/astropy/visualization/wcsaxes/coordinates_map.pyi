...
from .coordinate_range import find_coordinate_range as find_coordinate_range
from .frame import RectangularFrame as RectangularFrame, RectangularFrame1D as RectangularFrame1D
...
class CoordinatesMap:
    ...
    _coords: Incomplete
    _aliases: Incomplete
    def __init__(self, axes, transform: Incomplete | None = None, coord_meta: Incomplete | None = None, frame_class=..., previous_frame_path: Incomplete | None = None) -> None: ...
    def __getitem__(self, item): ...
    def __contains__(self, item) -> bool: ...
    def set_visible(self, visibility) -> None: ...
    def __iter__(self): ...
