...
class SphericalCircle(Polygon):
    ...
    """
    def __init__(self, center, radius, resolution: int = 100, vertex_unit=..., **kwargs) -> None: ...
...
class Quadrangle(Polygon):
    ...
    Additional keyword arguments are passed to `~matplotlib.patches.Polygon`
    """
    def __init__(self, anchor, width, height, resolution: int = 100, vertex_unit=..., **kwargs) -> None: ...
