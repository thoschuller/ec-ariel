...
class Equivalency(list):
    ...
    name: Incomplete
    kwargs: Incomplete
    def __init__(self, equiv_list, name: str = '', kwargs: Incomplete | None = None) -> None: ...
...
def spectral():
    ...
    """
def spectral_density(wav, factor: Incomplete | None = None):
    """
...
def mass_energy():
    ...
    """
def brightness_temperature(frequency, beam_area: Incomplete | None = None):
    '''
...
def beam_angular_area(beam_area):
    ...
    """
def thermodynamic_temperature(frequency, T_cmb: Incomplete | None = None):
...
def plate_scale(platescale):
    ...
    """
def magnetic_flux_field(mu_r: int = 1):
    """
