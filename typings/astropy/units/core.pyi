...
__all__ = ['UnitBase', 'NamedUnit', 'IrreducibleUnit', 'Unit', 'CompositeUnit', 'PrefixUnit', 'UnrecognizedUnit', 'def_unit', 'get_current_unit_registry', 'set_enabled_units', 'add_enabled_units', 'set_enabled_equivalencies', 'add_enabled_equivalencies', 'set_enabled_aliases', 'add_enabled_aliases', 'dimensionless_unscaled', 'one']
...
class _UnitRegistry:
    ...
    _aliases: Incomplete
    _all_units: Incomplete
    _registry: Incomplete
    _non_prefix_units: Incomplete
    _by_physical_type: Incomplete
...
class UnitBase:
    ...
    """
    __array_priority__: Final[Literal[1000]]
    ...
    def to_string(self, format: type[unit_format.Base] | str | None = ..., **kwargs) -> str:
    ...
    def to(self, other, value=..., equivalencies=[]):
        ...
        """
    def in_units(self, other, value: float = 1.0, equivalencies=[]):
        """
    ...
    def decompose(self, bases=...) -> None:
        ...
        """
    def _compose(self, equivalencies=[], namespace=[], max_depth: int = 2, depth: int = 0, cached_results: Incomplete | None = None): ...
    def compose(self, equivalencies=[], units: Incomplete | None = None, max_depth: int = 2, include_prefix_units: Incomplete | None = None):
        """
    ...
    class EquivalentUnitsList(list):
        ...
        ROW_LEN: Final[Literal[3]]
        NO_EQUIV_UNITS_MSG: Final[str]
        def __repr__(self) -> str: ...
        ...
        def _process_equivalent_units(equiv_units_data):
            ...
            """
    def find_equivalent_units(self, equivalencies=[], units: Incomplete | None = None, include_prefix_units: bool = False):
        """
...
class NamedUnit(UnitBase):
    ...
    '''
    _names: Incomplete
    _short_names: Incomplete
    _long_names: Incomplete
    _format: Incomplete
    __doc__: Incomplete
    def __init__(self, st, doc: Incomplete | None = None, format: Incomplete | None = None, namespace: Incomplete | None = None) -> None: ...
    ...
    def _inject(self, namespace: Incomplete | None = None) -> None:
        """
...
class UnrecognizedUnit(IrreducibleUnit):
    ...
    def __bytes__(self) -> bytes: ...
    def __str__(self) -> str: ...
    def to_string(self, format: Incomplete | None = None): ...
    def _unrecognized_operator(self, *args, **kwargs) -> None: ...
    __pow__ = _unrecognized_operator
    __truediv__ = _unrecognized_operator
    __rtruediv__ = _unrecognized_operator
    __mul__ = _unrecognized_operator
    __rmul__ = _unrecognized_operator
    __lt__ = _unrecognized_operator
    __gt__ = _unrecognized_operator
    __le__ = _unrecognized_operator
    __ge__ = _unrecognized_operator
    __neg__ = _unrecognized_operator
    def __eq__(self, other): ...
    def __ne__(self, other): ...
    def is_equivalent(self, other, equivalencies: Incomplete | None = None): ...
    def get_converter(self, other, equivalencies: Incomplete | None = None) -> None: ...
    def _get_format_name(self, format: str) -> str: ...
...
class _UnitMetaClass(type):
    ...
    '''
    def __call__(self, s: str = '', represents: Incomplete | None = None, format: Incomplete | None = None, namespace: Incomplete | None = None, doc: Incomplete | None = None, parse_strict: str = 'raise'): ...
...
class Unit(NamedUnit, metaclass=_UnitMetaClass):
    ...
    ValueError
        If any of the given unit names are not valid Python tokens.
    '''
    _represents: Incomplete
    def __init__(self, st, represents: Incomplete | None = None, doc: Incomplete | None = None, format: Incomplete | None = None, namespace: Incomplete | None = None) -> None: ...
    @property
    def represents(self):
        """The unit that this named unit represents."""
    def decompose(self, bases=...): ...
...
class CompositeUnit(UnitBase):
    ...
    """
    _decomposed_cache: Incomplete
    _bases: Incomplete
    _powers: Incomplete
    _scale: Incomplete
    def __init__(self, scale, bases, powers, decompose: bool = False, decompose_bases=..., _error_check: bool = True) -> None: ...
    def __repr__(self) -> str: ...
    @property
    def scale(self) -> UnitScale:
    ...
    def _expand_and_gather(self, decompose: bool = False, bases=...): ...
    def __copy__(self) -> CompositeUnit: ...
    def decompose(self, bases=...): ...
    def is_unity(self) -> bool: ...

def def_unit(s, represents: Incomplete | None = None, doc: Incomplete | None = None, format: Incomplete | None = None, prefixes: bool = False, exclude_prefixes=[], namespace: Incomplete | None = None):
    '''Define a new unit.
...
dimensionless_unscaled: Final[CompositeUnit]
one: Final[CompositeUnit]
