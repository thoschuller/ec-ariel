...
from astropy.utils.compat.optional_deps import HAS_BLEACH as HAS_BLEACH
...
class XMLWriter:
    ...
    _tags: Incomplete
    _data: Incomplete
    _indentation: Incomplete
    xml_escape_cdata: Incomplete
    xml_escape: Incomplete
    def __init__(self, file) -> None:
        ...
        """
    def _flush(self, indent: bool = True, wrap: bool = False) -> None:
        """
    ...
    def start(self, tag, attrib={}, **extra):
        ...
        """
    def xml_cleaning_method(self, method: str = 'escape_xml', **clean_kwargs) -> Generator[None, None, Incomplete]:
        ...
        **clean_kwargs : keyword args
        ...
        '''
    def tag(self, tag, attrib={}, **extra) -> Generator[None]:
        """
    ...
    def data(self, text) -> None:
        ...
        """
    def end(self, tag: Incomplete | None = None, indent: bool = True, wrap: bool = False) -> None:
        """
    ...
    def close(self, id) -> None:
        ...
        """
    def element(self, tag, text: Incomplete | None = None, wrap: bool = False, attrib={}, **extra) -> None:
        """
        Adds an entire element.  This is the same as calling `start`,
        `data`, and `end` in sequence. The ``text`` argument
        can be omitted.
        """
    def string_element(self, xml_string) -> None:
        """
    ...
    def get_indentation(self):
        ...
        in.
        """
    def get_indentation_spaces(self, offset: int = 0):
        """
