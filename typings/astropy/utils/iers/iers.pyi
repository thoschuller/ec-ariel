...
from astropy_iers_data import IERS_A_FILE as IERS_A_FILE, IERS_A_README as IERS_A_README, IERS_A_URL as IERS_A_URL, IERS_A_URL_MIRROR as IERS_A_URL_MIRROR, IERS_B_FILE as IERS_B_FILE, IERS_B_README as IERS_B_README, IERS_B_URL as IERS_B_URL, IERS_LEAP_SECOND_FILE as IERS_LEAP_SECOND_FILE, IERS_LEAP_SECOND_URL as IERS_LEAP_SECOND_URL, IERS_LEAP_SECOND_URL_MIRROR as IETF_LEAP_SECOND_URL
...
FROM_IERS_B: int
FROM_IERS_A: int
FROM_IERS_A_PREDICTION: int
TIME_BEFORE_IERS_RANGE: int
TIME_BEYOND_IERS_RANGE: int
...
class Conf(_config.ConfigNamespace):
    ...
    """
    auto_download: Incomplete
    auto_max_age: Incomplete
    iers_auto_url: Incomplete
    iers_auto_url_mirror: Incomplete
    remote_timeout: Incomplete
    iers_degraded_accuracy: Incomplete
    system_leap_second_file: Incomplete
    iers_leap_second_auto_url: Incomplete
    ietf_leap_second_auto_url: Incomplete
...
class IERS(QTable):
    ...
    """
    iers_table: Incomplete
    @classmethod
    def open(cls, file: Incomplete | None = None, cache: bool = False, **kwargs):
    ...
    def close(cls) -> None:
        ...
        """
    def mjd_utc(self, jd1, jd2: float = 0.0):
        ...
        """
    def ut1_utc(self, jd1, jd2: float = 0.0, return_status: bool = False):
        ...
        """
    def dcip_xy(self, jd1, jd2: float = 0.0, return_status: bool = False):
        ...
        status : int or int array
            ...
            ``iers.TIME_BEYOND_IERS_RANGE``
        """
    def pm_xy(self, jd1, jd2: float = 0.0, return_status: bool = False):
        ...
        status : int or int array
            ...
            ``iers.TIME_BEYOND_IERS_RANGE``
        """
    def _check_interpolate_indices(self, indices_orig, indices_clipped, max_input_mjd) -> None:
        """
        ...
        """
    def _interpolate(self, jd1, jd2, columns, source: Incomplete | None = None): ...
    def _refresh_table_as_needed(self, mjd) -> None:
        """
...
class IERS_A(IERS):
    ...
    @classmethod
    def read(cls, file: str | os.PathLike[str] | None = None, readme: str | os.PathLike[str] | None = None) -> Self:
...
class IERS_B(IERS):
    ...
    iers_table: Incomplete
    @classmethod
    def read(cls, file: str | os.PathLike[str] | None = None, readme: str | os.PathLike[str] | None = None, data_start: int = 6) -> Self:
...
class LeapSeconds(QTable):
    ...
    """
    _re_expires: Incomplete
    _expires: Incomplete
    _auto_open_files: Incomplete
    @classmethod
    def open(cls, file: Incomplete | None = None, cache: bool = False):
    ...
    def _today(): ...
    @classmethod
    def auto_open(cls, files: Incomplete | None = None):
    ...
    def from_leap_seconds_list(cls, file):
        ...
        """
    @classmethod
    def from_erfa(cls, built_in: bool = False):
        ...
        built_in : bool
            ...
            with erfa.
        """
    def update_erfa_leap_seconds(self, initialize_erfa: bool = False):
