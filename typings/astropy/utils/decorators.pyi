...
def deprecated(since, message: str = '', name: str = '', alternative: str = '', pending: bool = False, obj_type: Incomplete | None = None, warning_type=..., *, pending_warning_type=...):
    """
    ...
    """
def deprecated_attribute(name, since, message: Incomplete | None = None, alternative: Incomplete | None = None, pending: bool = False, warning_type=..., pending_warning_type=...):
    '''
    ...
    ::
        ...
        class MyClass2:
            ...
            def method(self):
                self.new_name = 24
    '''
def deprecated_renamed_argument(old_name, new_name, since, arg_in_kwargs: bool = False, relax: bool = False, pending: bool = False, warning_type=..., alternative: str = '', message: str = ''):
...
class classproperty(property):
    ...
    re-evaluated for the subclass::
        ...
        1
    '''
    def __new__(cls, fget: Incomplete | None = None, doc: Incomplete | None = None, lazy: bool = False): ...
    _lazy: Incomplete
    _lock: Incomplete
    _cache: Incomplete
    __doc__: Incomplete
    def __init__(self, fget, doc: Incomplete | None = None, lazy: bool = False) -> None: ...
