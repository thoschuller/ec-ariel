...
def z_at_value(func, fval, zmin: float = 1e-08, zmax: int = 1000, ztol: float = 1e-08, maxfun: int = 500, method: str = 'Brent', bracket: Incomplete | None = None, *, verbose: bool = False):
