...
from astropy.table import QTable as QTable, Row as Row, Table as Table
from collections.abc import Mapping

def from_row(row: Row, *, move_to_meta: bool = False, cosmology: str | type[_CosmoT] | None = None, rename: Mapping[str, str] | None = None) -> _CosmoT:
    ...
    keyword argument.
        ...
        True
    '''
def to_row(cosmology: Cosmology, *args: object, cosmology_in_meta: bool = False, table_cls: type[Table] = ..., rename: Mapping[str, str] | None = None) -> Row:
    ...
    *args
    ...
    The columns can be renamed using the ``rename`` keyword argument.
        ...
        FlatLambdaCDM Planck18        67.66 0.30966  2.7255   3.046 0.0 .. 0.06 0.04897
    '''
def row_identify(origin: str, format: str | None, *args: object, **kwargs: object) -> bool:
