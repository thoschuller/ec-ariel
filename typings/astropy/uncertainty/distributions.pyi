...
def normal(center, *, std: Incomplete | None = None, var: Incomplete | None = None, ivar: Incomplete | None = None, n_samples, cls=..., **kwargs):
    """
    ...
    """
def poisson(center, n_samples, cls=..., **kwargs):
    """
    ...
    distr : `~astropy.uncertainty.Distribution` or object
        ...
        The type will be the same as the parameter ``cls``.
    """
def uniform(*, lower: Incomplete | None = None, upper: Incomplete | None = None, center: Incomplete | None = None, width: Incomplete | None = None, n_samples, cls=..., **kwargs):
    """
