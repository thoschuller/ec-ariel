...
class NDData(NDDataBase):
    ...
    _wcs: Incomplete
    _unit: Incomplete
    def __init__(self, data, uncertainty: Incomplete | None = None, mask: Incomplete | None = None, wcs: Incomplete | None = None, meta: Incomplete | None = None, unit: Incomplete | None = None, copy: bool = False, psf: Incomplete | None = None) -> None: ...
