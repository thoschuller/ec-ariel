...
class BitFlag(int):
    ...
    def __new__(cls, val, doc: Incomplete | None = None): ...
...
class BitFlagNameMeta(type):
    ...
    def __iadd__(cls, other) -> None: ...
    def __delattr__(cls, name) -> None: ...
    def __delitem__(cls, name) -> None: ...
...
def extend_bit_flag_map(cls_name, base_cls=..., **kwargs):
    """
    ...
    **kwargs : int
    ...
    """
def interpret_bit_flags(bit_flags, flip_bits: Incomplete | None = None, flag_name_map: Incomplete | None = None):
    '''
    ...
    '''
def bitfield_to_boolean_mask(bitfield, ignore_flags: int = 0, flip_bits: Incomplete | None = None, good_mask_value: bool = False, dtype=..., flag_name_map: Incomplete | None = None):
    '''
