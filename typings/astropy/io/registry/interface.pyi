...
class UnifiedReadWrite:
    ...
    _cls: Incomplete
    _method_name: Incomplete
    def __init__(self, instance, cls, method_name, registry: Incomplete | None = None) -> None: ...
    @property
    def registry(self):
        """Unified I/O registry instance."""
    def help(self, format: Incomplete | None = None, out: Incomplete | None = None) -> None:
        ...
        """
    def list_formats(self, out: Incomplete | None = None):
