...
class _UnifiedIORegistryBase:
    ...
    _delayed_docs_classes: Incomplete
    ...
    def available_registries(self):
        ...
        ``dict_keys``
        """
    def get_formats(self, data_class: Incomplete | None = None, filter_on: Incomplete | None = None):
        '''
        ...
        '''
    def delay_doc_updates(self, cls) -> Generator[None]:
        ...
        """
    def register_identifier(self, data_format, data_class, identifier, force: bool = False) -> None:
        '''
    ...
    def _get_highest_priority_format(self, mode, cls, valid_formats):
        ...
        error.
        """
    def _update__doc__(self, data_class, readwrite) -> None:
        """
