...
class UnifiedInputRegistry(_UnifiedIORegistryBase):
    ...
    """
    _readers: Incomplete
    _registries_order: Incomplete
    def __init__(self) -> None: ...
    def register_reader(self, data_format, data_class, function, force: bool = False, priority: int = 0) -> None:
        """
    ...
    def get_reader(self, data_format, data_class):
        ...
        """
    def read(self, cls, *args, format: Incomplete | None = None, cache: bool = False, **kwargs):
        """
        Read in data.
...
class UnifiedOutputRegistry(_UnifiedIORegistryBase):
    ...
    _registries_order: Incomplete
    def __init__(self) -> None: ...
    def register_writer(self, data_format, data_class, function, force: bool = False, priority: int = 0) -> None:
        """
    ...
    def get_writer(self, data_format, data_class):
        ...
        """
    def write(self, data, *args, format: Incomplete | None = None, **kwargs):
        """
        Write out data.
...
class UnifiedIORegistry(UnifiedInputRegistry, UnifiedOutputRegistry):
    ...
    _registries_order: Incomplete
    def __init__(self) -> None: ...
    def get_formats(self, data_class: Incomplete | None = None, readwrite: Incomplete | None = None):
        '''
