...
class UCDWords:
    ...
    """
    _primary: Incomplete
    _secondary: Incomplete
    _descriptions: Incomplete
    _capitalization: Incomplete
...
def parse_ucd(ucd, check_controlled_vocabulary: bool = False, has_colon: bool = False):
    """
    ...
    ValueError
        if *ucd* is invalid
    """
def check_ucd(ucd, check_controlled_vocabulary: bool = False, has_colon: bool = False):
    """
