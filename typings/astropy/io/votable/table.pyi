...
def parse(source, columns: Incomplete | None = None, invalid: str = 'exception', verify: Incomplete | None = None, chunk_size=..., table_number: Incomplete | None = None, table_id: Incomplete | None = None, filename: Incomplete | None = None, unit_format: Incomplete | None = None, datatype_mapping: Incomplete | None = None, _debug_python_based_parser: bool = False):
    '''
...
def parse_single_table(source, **kwargs):
    ...
    """
def writeto(table, file, tabledata_format: Incomplete | None = None) -> None:
    """
    ...
    """
def validate(source, output=..., xmllint: bool = False, filename: Incomplete | None = None):
    """
    ...
    """
def from_table(table, table_id: Incomplete | None = None):
    """
