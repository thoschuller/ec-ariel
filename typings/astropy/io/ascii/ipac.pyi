from . import basic as basic, core as core, fixedwidth as fixedwidth
from _typeshed import Incomplete
from astropy.table.pprint import get_auto_format_func as get_auto_format_func
...
class IpacHeaderSplitter(core.BaseSplitter):
    ...
    """
    process_line: Incomplete
    process_val: Incomplete
    delimiter: str
    delimiter_pad: str
    skipinitialspace: bool
    comment: str
    write_comment: str
    col_starts: Incomplete
    col_ends: Incomplete
...
class Ipac(basic.Basic):
    ...
    * ``definition='right'``::
    ...
    def __init__(self, definition: str = 'ignore', DBMS: bool = False) -> None: ...
