...
from .core import DefaultSplitter as DefaultSplitter, InconsistentTableError as InconsistentTableError
...
class FixedWidthHeader(basic.BasicHeader):
    ...
    position_line: Incomplete
    set_of_position_line_characters: Incomplete
...
class FixedWidth(basic.Basic):
    ...
    def __init__(self, col_starts: Incomplete | None = None, col_ends: Incomplete | None = None, delimiter_pad: str = ' ', bookend: bool = True, header_rows: Incomplete | None = None) -> None: ...
...
class FixedWidthNoHeader(FixedWidth):
    ...
    def __init__(self, col_starts: Incomplete | None = None, col_ends: Incomplete | None = None, delimiter_pad: str = ' ', bookend: bool = True) -> None: ...
...
class FixedWidthTwoLine(FixedWidth):
    ...
    def __init__(self, position_line: Incomplete | None = None, position_char: str = '-', delimiter_pad: Incomplete | None = None, bookend: bool = False, header_rows: Incomplete | None = None) -> None: ...
