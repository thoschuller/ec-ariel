...
def getheader(filename, *args, **kwargs):
    ...
    **kwargs
    ...
    """
def getdata(filename, *args, header: Incomplete | None = None, lower: Incomplete | None = None, upper: Incomplete | None = None, view: Incomplete | None = None, **kwargs):
    """
...
def getval(filename, keyword, *args, **kwargs):
    ...
    **kwargs
    ...
    """
def setval(filename, keyword, *args, value: Incomplete | None = None, comment: Incomplete | None = None, before: Incomplete | None = None, after: Incomplete | None = None, savecomment: bool = False, **kwargs) -> None:
    """
...
def delval(filename, keyword, *args, **kwargs) -> None:
    ...
    **kwargs
        ...
        *Note:* This function automatically specifies ``do_not_scale_image_data
        ...
        unmodified header.
    """
def writeto(filename, data, header: Incomplete | None = None, output_verify: str = 'exception', overwrite: bool = False, checksum: bool = False) -> None:
    '''
    ...
    '''
def table_to_hdu(table, character_as_bytes: bool = False):
    """
    ...
    """
def append(filename, data, header: Incomplete | None = None, checksum: bool = False, verify: bool = True, **kwargs) -> None:
    """
...
def update(filename, data, *args, **kwargs) -> None:
    ...
    **kwargs
        ...
        `astropy.io.fits.open`.
    """
def info(filename, output: Incomplete | None = None, **kwargs):
    """
...
def printdiff(inputa, inputb, *args, **kwargs) -> None:
    ...
    **kwargs
    ...
    directly.
    """
def tabledump(filename, datafile: Incomplete | None = None, cdfile: Incomplete | None = None, hfile: Incomplete | None = None, ext: int = 1, overwrite: bool = False) -> None:
    """
    ...
    three ASCII files.
    """
def tableload(datafile, cdfile, hfile: Incomplete | None = None):
    """
