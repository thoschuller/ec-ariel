import csv
from .base import DELAYED as DELAYED, ExtensionHDU as ExtensionHDU, _ValidHDU as _ValidHDU
from _typeshed import Incomplete
from astropy.io.fits.column import ATTRIBUTE_TO_KEYWORD as ATTRIBUTE_TO_KEYWORD, ColDefs as ColDefs, Column as Column, FITS2NUMPY as FITS2NUMPY, KEYWORD_NAMES as KEYWORD_NAMES, KEYWORD_TO_ATTRIBUTE as KEYWORD_TO_ATTRIBUTE, TDEF_RE as TDEF_RE, _AsciiColDefs as _AsciiColDefs, _FormatP as _FormatP, _FormatQ as _FormatQ, _cmp_recformats as _cmp_recformats, _convert_format as _convert_format, _makep as _makep, _parse_tformat as _parse_tformat, _scalar_to_format as _scalar_to_format
from astropy.io.fits.fitsrec import FITS_rec as FITS_rec, _get_recarray_field as _get_recarray_field, _has_unicode_fields as _has_unicode_fields
from astropy.io.fits.header import Header as Header, _pad_length as _pad_length
from astropy.io.fits.util import _is_int as _is_int, _str_to_num as _str_to_num, path_like as path_like
...
class _TableLikeHDU(_ValidHDU):
    ...
    def match_header(cls, header) -> None:
        ...
        """
    @classmethod
    def from_columns(cls, columns, header: Incomplete | None = None, nrows: int = 0, fill: bool = False, character_as_bytes: bool = False, **kwargs):
        '''
    ...
    def _init_tbdata(self, data) -> None: ...
    def _update_load_data(self) -> None:
        """Load the data if asked to."""
    data: Incomplete
    def _update_column_added(self, columns, column) -> None:
        """
        Update the data upon addition of a new column through the `ColDefs`
        interface.
        """
    def _update_column_removed(self, columns, col_idx) -> None:
        """
...
class _TableBaseHDU(ExtensionHDU, _TableLikeHDU):
    ...
    _uint: Incomplete
    _character_as_bytes: Incomplete
    _header: Incomplete
    data: Incomplete
    name: Incomplete
    ver: Incomplete
    def __init__(self, data: Incomplete | None = None, header: Incomplete | None = None, name: Incomplete | None = None, uint: bool = False, ver: Incomplete | None = None, character_as_bytes: bool = False) -> None: ...
    @classmethod
    def match_header(cls, header) -> None:
        """
    ...
    def _summary(self):
        ...
        """
    def _update_column_removed(self, columns, idx) -> None: ...
    def _update_column_attribute_changed(self, column, col_idx, attr, old_value, new_value) -> None:
        """
        Update the header when one of the column objects is updated.
        """
    def _clear_table_keywords(self, index: Incomplete | None = None) -> None:
        """
        ...
        """
    def _populate_table_keywords(self) -> None:
...
class TableHDU(_TableBaseHDU):
    ...
    __format_RE: Incomplete
    def __init__(self, data: Incomplete | None = None, header: Incomplete | None = None, name: Incomplete | None = None, ver: Incomplete | None = None, character_as_bytes: bool = False) -> None: ...
    @classmethod
...
class BinTableHDU(_TableBaseHDU):
    ...
    def _writedata_by_row(self, fileobj) -> None: ...
    _tdump_file_format: Incomplete
    def dump(self, datafile: Incomplete | None = None, cdfile: Incomplete | None = None, hfile: Incomplete | None = None, overwrite: bool = False) -> None:
        """
        ...
        """
    def load(cls, datafile, cdfile: Incomplete | None = None, hfile: Incomplete | None = None, replace: bool = False, header: Incomplete | None = None):
        """
...
def _binary_table_byte_swap(data) -> Generator[Incomplete]:
    """
